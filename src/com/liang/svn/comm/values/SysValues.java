 ...
 *
 */
package com.liang.svn.comm.values;
...
public final class SysValues {
	...
	public String SYSTEM_ICON_IMG = "sys_ico.png";

	// system main
	public String MAIN_VIEW_TITLE = "SVN版本发布";// 主界面标题
	...
	public int MAIN_VIEW_HEADER_WIDTH = 885;

	public int MAIN_VIEW_HEADER_HEIGHT = 56;

	public String MAIN_VIEW_HEADER_IMG_01 = "01_sys_main_header.png";

	public int MAIN_VIEW_HEADER_WIDTH_01 = 885;

	public int MAIN_VIEW_HEADER_HEIGHT_01 = 18;

	public String MAIN_VIEW_HEADER_IMG_02 = "02_sys_main_header.png";

	public int MAIN_VIEW_HEADER_WIDTH_02 = 885;

	public int MAIN_VIEW_HEADER_HEIGHT_02 = 38;

	public String MAIN_VIEW_FOOTER_IMG = "sys_main_footer.png";

	public int MAIN_VIEW_FOOTER_WIDTH = 885;

	public int MAIN_VIEW_FOOTER_HEIGHT = 40;
	...
	public String MAIN_VIEW_LEFT_MENU_IMG_MLYS = "sys_left_menu_mlys.png";

	public String MAIN_VIEW_COMMON_BTN_SAVE = "btn_bc.png";

	public int BTN_TYPE_SAVE = 1;
	// system login
